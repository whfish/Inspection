...
//    private float[] number=getArguments ().getFloatArray ("number");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        System.out.println (getArguments ().getFloatArray ("number")[1]);
    ...
    private void initDatas() {
        ...
        values.add (new SliceValue (getArguments ().getFloatArray ("number")[1], Color.RED));
        values.add (new SliceValue (getArguments ().getFloatArray ("number")[2], Color.GRAY));
        values.add (new SliceValue (getArguments ().getFloatArray ("number")[3], Color.GREEN));
        values.add (new SliceValue (getArguments ().getFloatArray ("number")[4], Color.YELLOW));
